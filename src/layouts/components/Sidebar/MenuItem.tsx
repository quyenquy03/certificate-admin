...
export const MenuItem = ({
  ...
  return (
    ...
    >
      <span
        className={cn(
          "flex h-10 w-10 items-center justify-center rounded-xl bg-slate-100 text-slate-500 transition-all duration-200 group-hover:bg-blue-50 group-hover:text-blue-600 dark:bg-slate-800/80 dark:text-slate-300 dark:group-hover:bg-blue-500/25 dark:group-hover:text-blue-200",
      ...
      <span
        className={cn(
          "pointer-events-none absolute inset-px rounded-[14px] opacity-0 transition-opacity duration-200 group-hover:opacity-100",
          !isActive &&

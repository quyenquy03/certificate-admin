    ...
    <div className="pt-0">
      ...
      >
        ...
        <div className="relative mx-auto flex max-w-6xl flex-col items-center gap-10 px-6 pb-24 pt-32 sm:px-8 md:pt-36">
          ...
          >
            Giải pháp giúp nhà trường, doanh nghiệp và học viên xác thực văn
            bằng chỉ trong vài giây. Mỗi chứng chỉ được mã hóa, lưu trữ phi tập
            trung và có thể kiểm chứng ở mọi nơi, mọi lúc — đảm bảo minh bạch,
            an toàn và không thể làm giả.
          </motion.p>
          <motion.div
      ...
      >
        <div className="mx-auto max-w-6xl px-6 py-16 sm:px-8 md:py-20">
          ...
          <p className="mt-4 max-w-3xl text-center text-slate-300 sm:mx-auto">
            Quy trình của CertifyChain được xây dựng xoay quanh trải nghiệm
            người dùng và tính minh bạch tuyệt đối. Từ khâu phát hành, lưu trữ
            đến xác thực, mọi dữ liệu đều được xử lý tự động và an toàn trên
            blockchain.
          </p>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              {benefits.map((benefit) => {
                ...
                return (
                  <Card
                    key={benefit.title}
                    className="border border-indigo-500/10 bg-slate-900/60 text-left"
                  >
      ...
      >
        ...
        <p className="mt-4 max-w-3xl text-center text-slate-300 sm:mx-auto">
          Dành cho nhà tuyển dụng, phòng nhân sự và cựu sinh viên. Chỉ cần một
          cú nhấp chuột để xác minh thông tin đúng chuẩn blockchain.
        </p>
        <div className="mt-10 grid gap-6 lg:grid-cols-3">
          {lookupFeatures.map((feature) => {
            ...
            return (
              <Card
                key={feature.title}
                className="border border-indigo-500/10 bg-slate-900/50 text-left"
              >
      ...
      >
        <div className="mx-auto max-w-6xl px-6 py-16 sm:px-8 md:py-20">
          ...
          <p className="mt-4 max-w-3xl text-center text-slate-300 sm:mx-auto">
            Nền tảng được tin dùng bởi các trường đại học, doanh nghiệp tuyển
            dụng và tổ chức chứng nhận trên khắp châu Á.
          </p>
      ...
      >
        <div className="mx-auto flex max-w-5xl flex-col items-center gap-6 px-6 py-20 sm:px-8">
          ...
          <p className="max-w-2xl text-lg text-slate-300">
            Đội ngũ CertifyChain hỗ trợ phân tích nhu cầu, kết nối API và đào
            tạo vận hành chỉ trong vài ngày.
          </p>
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-2">
          <Card className="border border-indigo-500/10 bg-slate-900/60 text-left">
            <CardHeader>
              ...
              <CardDescription className="text-slate-300">
                Nhận tư vấn triển khai, cung cấp lộ trình onboarding riêng và
                tài liệu kỹ thuật cho đội ngũ của bạn.
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card className="border border-indigo-500/10 bg-slate-900/60 text-left">
            <CardHeader className="space-y-3">
              ...
              <CardDescription className="text-slate-300">
                Vui lòng điền thông tin để chúng tôi liên hệ tư vấn chi tiết
